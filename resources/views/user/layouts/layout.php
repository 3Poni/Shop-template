	...
	<ul class="nav navbar-nav toolbar pull-right">
		...
		<li class="dropdown toolbar-icon-bg">
			...
			<ul class="dropdown-menu userinfo arrow">
				<li><a href="/user"><span class="pull-left">Основное меню</span> <span class="badge badge-info">80%</span></a></li>
				<li><a href="/"><span class="pull-left">Вернуться в магазин</span> <i class="pull-right fa fa-user"></i></a></li>
				<li><a href="/user/settings"><span class="pull-left">Настройки</span> <i class="pull-right fa fa-cog"></i></a></li>
				<li class="divider"></li>
        ...
        <div class="widget-body welcome-box tabular">
            <div class="tabular-row">
                ...
                <div class="tabular-cell welcome-options">
                    ...
                    <a href="#" class="name"><?php echo $_SESSION['user']['login']; ?></a>
                </div>
            </div>
        </div>
    </div>
