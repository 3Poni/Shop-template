    ...
    <ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <ul class="dropdown-menu userinfo arrow">
                <li><a href="/admin"><span class="pull-left">Основное меню</span>
                <li><a href="/"><span class="pull-left">Вернуться в магазин</span> <i class="pull-right fa fa-user"></i></a>
                </li>
                <li><a href="/admin/settings"><span class="pull-left">Настройки</span> <i
                                ...
                                <div class="tabular-row">
                                    ...
                                    <div class="tabular-cell welcome-options">
                                        ...
                                        <a href="/admin/settings"
                                           class="name"><?php echo $_SESSION['admin']['login']; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="widget stay-on-collapse" id="widget-sidebar">
                            <nav role="navigation" class="widget-body">
                                <ul class="acc-menu">
                                    ...
                                    <li><a href="/admin/categories"><i class="fa fa-home"></i><span>Категории</span>
                                            <?php if(isset($countCategories)){
                                                echo '<span class="badge badge-primary">' .
                                                    $countCategories . ' </span>';
                                            }?>
                                        </a>
                                    </li>
                                    </li>
                                    <li><a href="/admin/items"><i class="fa fa-columns"></i><span>Товары</span>
                                    ...
                                    <li><a href="/admin/users"><i class="fa fa-flask"></i><span>Пользователи</span>
                                    ...
                                    <li><a href="/admin/orders"><i class="fa fa-cogs"></i><span>Список заказов</span>
                                                <?php if(isset($countOrders)){
                                                    echo '<span class="badge badge-primary">' .
                                                    $countOrders . '</span>';
                                                }?>
                                        </a>
